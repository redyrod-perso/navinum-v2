...
function QuizApp() {
    ...
    useEffect(() => {
        ...
        try {
            ...
            const mercurePublicUrl = window.APP_CONFIG?.MERCURE_PUBLIC_URL || 'https://activites-touristiques.online/.well-known/mercure';
            const mercureUrl = new URL(mercurePublicUrl);
